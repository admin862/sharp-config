				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="/admin/groupInfo/list">组列表</a>
							</li>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="groupName" placeholder="名称" class="col-xs-10 col-sm-5" />
										</div>
									</div>
		...
		<script type="text/javascript">
			jQuery(function($) {
				$("#btnAjaxForm").click(function(){
                    ...
                    groupInfo.environmentId = $("#environmentId").val();
                    if(groupInfo.environmentId == -1){
                        alert("请选择环境");
                        return;
					}
					$.post("add",groupInfo,function (data) {
						alert(data);
                    });
				})
			});
